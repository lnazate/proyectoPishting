...
public class Main {
    private static final String KEYWORDS_FILE = "C:\\Users\\Asus\\IdeaProjects\\PhishingChecker\\src\\info.txt";
    private static final String MESSAGE_FILE = "C:\\Users\\Asus\\IdeaProjects\\PhishingChecker\\src\\phishing_keywords.txt";
    ...
    private static void printOccurrenceInfo(String keyword, int occurrences, int points) {
        System.out.printf("%s: %d concurrencias, %d puntos%n", keyword, occurrences, points);
    }

    private static void handleIOException(IOException e) {
        // Manejar la excepción según tus necesidades (mostrar un mensaje, registrar, etc.)
        e.printStackTrace();
    }
